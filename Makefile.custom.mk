...
install-vpa-crds:
	curl -sL https://raw.githubusercontent.com/kubernetes/autoscaler/vertical-pod-autoscaler-1.3.0/vertical-pod-autoscaler/deploy/vpa-v1-crd-gen.yaml | kubectl --kubeconfig=kyverno-kubeconfig.yaml apply -f -
