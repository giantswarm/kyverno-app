...
- Adds a `validate-policy-exception` ClusterPolicy to ensure that PolicyExceptions are installed in a determined namespace.
...
[Unreleased]: https://github.com/giantswarm/kyverno-app/compare/v0.14.2...HEAD
